...
/**
 * This class defines the structure of the 'legacy_cart_item_attribute_combination' table.
 *
 *
 *
 ...
 *
 */
class LegacyCartItemAttributeCombinationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'LegacyProductAttributes.Model.Map.LegacyCartItemAttributeCombinationTableMap';
     ...
     */
    const TABLE_NAME = 'legacy_cart_item_attribute_combination';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\LegacyProductAttributes\\Model\\LegacyCartItemAttributeCombination';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'LegacyProductAttributes.Model.LegacyCartItemAttributeCombination';
     ...
     */
    const CART_ITEM_ID = 'legacy_cart_item_attribute_combination.CART_ITEM_ID';

    /**
     * the column name for the ATTRIBUTE_ID field
     */
    const ATTRIBUTE_ID = 'legacy_cart_item_attribute_combination.ATTRIBUTE_ID';

    /**
     * the column name for the ATTRIBUTE_AV_ID field
     */
    const ATTRIBUTE_AV_ID = 'legacy_cart_item_attribute_combination.ATTRIBUTE_AV_ID';
    ...
    {
        // attributes
        $this->setName('legacy_cart_item_attribute_combination');
     ...
     * and findPk*() calls.
     *
     * @param \LegacyProductAttributes\Model\LegacyCartItemAttributeCombination $obj A \LegacyProductAttributes\Model\LegacyCartItemAttributeCombination object.
     ...
     *
     * @param mixed $value A \LegacyProductAttributes\Model\LegacyCartItemAttributeCombination object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \LegacyProductAttributes\Model\LegacyCartItemAttributeCombination) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \LegacyProductAttributes\Model\LegacyCartItemAttributeCombination object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? LegacyCartItemAttributeCombinationTableMap::CLASS_DEFAULT : LegacyCartItemAttributeCombinationTableMap::OM_CLASS;
    }
     ...
     * @return array (LegacyCartItemAttributeCombination object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = LegacyCartItemAttributeCombinationTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = LegacyCartItemAttributeCombinationTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + LegacyCartItemAttributeCombinationTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = LegacyCartItemAttributeCombinationTableMap::OM_CLASS;
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            LegacyCartItemAttributeCombinationTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = LegacyCartItemAttributeCombinationTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = LegacyCartItemAttributeCombinationTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(LegacyCartItemAttributeCombinationTableMap::DATABASE_NAME)->getTable(LegacyCartItemAttributeCombinationTableMap::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getServiceContainer()->getDatabaseMap(LegacyCartItemAttributeCombinationTableMap::DATABASE_NAME);
      if (!$dbMap->hasTable(LegacyCartItemAttributeCombinationTableMap::TABLE_NAME)) {
        $dbMap->addTableObject(new LegacyCartItemAttributeCombinationTableMap());
      }
    }

    /**
     * Performs a DELETE on the database, given a LegacyCartItemAttributeCombination or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or LegacyCartItemAttributeCombination object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \LegacyProductAttributes\Model\LegacyCartItemAttributeCombination) { // it's a model object
        ...
        if ($values instanceof Criteria) { LegacyCartItemAttributeCombinationTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { LegacyCartItemAttributeCombinationTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return LegacyCartItemAttributeCombinationQuery::create()->doDeleteAll($con);
    }
...
} // LegacyCartItemAttributeCombinationTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
LegacyCartItemAttributeCombinationTableMap::buildTableMap();
