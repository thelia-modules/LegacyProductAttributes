...
abstract class LegacyCartItemAttributeCombination implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\LegacyProductAttributes\\Model\\Map\\LegacyCartItemAttributeCombinationTableMap';
    ...
    /**
     * Initializes internal state of LegacyProductAttributes\Model\Base\LegacyCartItemAttributeCombination object.
     */
    ...
    /**
     * Compares this with another <code>LegacyCartItemAttributeCombination</code> instance.  If
     * <code>obj</code> is an instance of <code>LegacyCartItemAttributeCombination</code>, delegates to
     * <code>equals(LegacyCartItemAttributeCombination)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return LegacyCartItemAttributeCombination The current object, for fluid interface
     */
    ...
    public function setCartItemId($v)
    {
        ...
        if ($this->cart_item_id !== $v) {
            $this->cart_item_id = $v;
            $this->modifiedColumns[LegacyCartItemAttributeCombinationTableMap::CART_ITEM_ID] = true;
        }
    ...
    public function setAttributeId($v)
    {
        ...
        if ($this->attribute_id !== $v) {
            $this->attribute_id = $v;
            $this->modifiedColumns[LegacyCartItemAttributeCombinationTableMap::ATTRIBUTE_ID] = true;
        }
    ...
    public function setAttributeAvId($v)
    {
        ...
        if ($this->attribute_av_id !== $v) {
            ...
            $this->modifiedColumns[LegacyCartItemAttributeCombinationTableMap::ATTRIBUTE_AV_ID] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLegacyCartItemAttributeCombinationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildLegacyCartItemAttributeCombinationQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LegacyCartItemAttributeCombinationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LegacyCartItemAttributeCombinationTableMap::ATTRIBUTE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ATTRIBUTE_ID';
        }
        if ($this->isColumnModified(LegacyCartItemAttributeCombinationTableMap::ATTRIBUTE_AV_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ATTRIBUTE_AV_ID';
        }

        $sql = sprintf(
            'INSERT INTO legacy_cart_item_attribute_combination (%s) VALUES (%s)',
    ...
    {
        $pos = LegacyCartItemAttributeCombinationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LegacyProductAttributes\Model\LegacyCartItemAttributeCombination (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \LegacyProductAttributes\Model\LegacyCartItemAttributeCombination Clone of current object.
     * @throws PropelException
     */
    ...
    public function getAttribute(ConnectionInterface $con = null)
    {
        if ($this->aAttribute === null && ($this->attribute_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAttribute->addLegacyCartItemAttributeCombinations($this);
             */
        }
    ...
    public function getAttributeAv(ConnectionInterface $con = null)
    {
        if ($this->aAttributeAv === null && ($this->attribute_av_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAttributeAv->addLegacyCartItemAttributeCombinations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LegacyCartItemAttributeCombinationTableMap::DEFAULT_STRING_FORMAT);
    }
