...
abstract class LegacyProductAttributeValue implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\LegacyProductAttributes\\Model\\Map\\LegacyProductAttributeValueTableMap';
    ...
    /**
     * Compares this with another <code>LegacyProductAttributeValue</code> instance.  If
     * <code>obj</code> is an instance of <code>LegacyProductAttributeValue</code>, delegates to
     * <code>equals(LegacyProductAttributeValue)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return LegacyProductAttributeValue The current object, for fluid interface
     */
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[LegacyProductAttributeValueTableMap::PRODUCT_ID] = true;
        }
    ...
    public function setAttributeAvId($v)
    {
        ...
        if ($this->attribute_av_id !== $v) {
            ...
            $this->modifiedColumns[LegacyProductAttributeValueTableMap::ATTRIBUTE_AV_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LegacyProductAttributeValueTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLegacyProductAttributeValueQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildLegacyProductAttributeValueQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LegacyProductAttributeValueTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LegacyProductAttributeValueTableMap::PRODUCT_ID)) {
    ...
    {
        $pos = LegacyProductAttributeValueTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LegacyProductAttributeValue'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LegacyProductAttributeValue'][serialize($this->getPrimaryKey())] = true;
        $keys = LegacyProductAttributeValueTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(LegacyProductAttributeValueTableMap::DATABASE_NAME);
        $criteria->add(LegacyProductAttributeValueTableMap::PRODUCT_ID, $this->product_id);
        $criteria->add(LegacyProductAttributeValueTableMap::ATTRIBUTE_AV_ID, $this->attribute_av_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getProductId()) && (null === $this->getAttributeAvId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LegacyProductAttributes\Model\LegacyProductAttributeValue (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \LegacyProductAttributes\Model\LegacyProductAttributeValue Clone of current object.
     * @throws PropelException
     */
    ...
    public function setProduct(ChildProduct $v = null)
    {
        ...
        if ($v !== null) {
            $v->addLegacyProductAttributeValue($this);
        }
    ...
    public function getProduct(ConnectionInterface $con = null)
    {
        if ($this->aProduct === null && ($this->product_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProduct->addLegacyProductAttributeValues($this);
             */
        }
    ...
    public function getAttributeAv(ConnectionInterface $con = null)
    {
        if ($this->aAttributeAv === null && ($this->attribute_av_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAttributeAv->addLegacyProductAttributeValues($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LegacyProductAttributeValueTableMap::DEFAULT_STRING_FORMAT);
    }
